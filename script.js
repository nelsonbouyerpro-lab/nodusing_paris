...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "brick.shot3": "L'Établi — vos voyages se gravent.",
      "brick.shot4": "Le Reliquaire — tout se gagne en jouant.",
      "brick.shot1.alt": "Le Moule du jour : des pièces colorées à glisser dans un moule vide.",
      "brick.shot2.alt": "La Grande Ascension : une carte de nœuds reliés menant au Sceau Final.",
      "brick.shot3.alt": "L'Établi du graveur : les poinçons des voyages achevés, le fil d'or du dernier Grand Œuvre.",
      "brick.shot4.alt": "Le Reliquaire : les reliques légendaires, payées en écus gagnés en jouant.",
      ...
      "brick.p3.d": "Aucune publicité ; l'argent réel reste un confort, jamais une obligation.",
    ...
    en: {
      ...
      "brick.shot3": "The Workbench — your journeys are engraved.",
      "brick.shot4": "The Reliquary — everything is earned by playing.",
      "brick.shot1.alt": "The Daily Mould: colourful pieces waiting to be slid into an empty mould.",
      "brick.shot2.alt": "The Great Ascension: a map of linked nodes leading to the Final Seal.",
      "brick.shot3.alt": "The engraver's Workbench: hallmarks of finished journeys, the golden thread of the last Great Work.",
      "brick.shot4.alt": "The Reliquary: legendary relics, paid with coins earned by playing.",
      ...
      "brick.p3.d": "No ads; real money stays a comfort, never a requirement.",
